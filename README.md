...
|---|---|---|---|
| 🟢 **GREEN** | Light green row | Strong alignment - mission, geography, size, and audience all match | **Apply** |
| 🟡 **YELLOW** | Light yellow row | Partial fit or needs follow-up - promising but something is unclear or requires outreach | **Review manually** |
| 🔴 **RED** | Light red row | Hard disqualifier found - wrong geography, closed, wrong focus, inactive, etc. | **Skip** |
...
Checks each of your disqualifiers one by one (e.g. "only funds universities", "no NJ grantees", "inactive 3+ years"). If any hard red flag is found → immediate **RED**.
...
- 🟢 **GREEN** if green flag count ≥ your threshold (default: 4)
- 🟡 **YELLOW** if below threshold, or matched a user-defined borderline condition
- 🔴 **RED** if any hard flag hit
